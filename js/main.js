$(function () {
  ...
  function init() {
    ...
    buttons.on("click", function (ev) {
      ev.stopPropagation();
      ev.preventDefault();
      var effect = $(this).data("effect") ?? "page-effect-4";
      // container.attr("class", "page-container");
      container.toggleClass(effect);
      if (!container.hasClass("page-menu-open")) {
        gsap.from(".page-menu ul li a", 0.5, {
          autoAlpha: 0,
          y: 100,
          ease: "back.out(1.5)",
          stagger: 0.3,
        });
        gsap.to(".page-menu .auth a", 0.5, {
          ease: "sine.inOut",
          x: 0,
        });
      }
      setTimeout(function () {
        container.toggleClass("page-menu-open");
      }, 25);
    });
  }
